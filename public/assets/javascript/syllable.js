  ...
  })(
    {
      1: [
        function(require, module, exports) {
          ...
          //---------- Start Event Listener block Haiku Input A--------------------//
           var $inputA = document.getElementsByTagName("input")[1];
           var $outputA = document.getElementsByTagName("outputA")[0];
  
           $inputA.addEventListener("input", oninputchangeA);
          
           oninputchangeA()
       
          function oninputchangeA() {
            $outputA.textContent = $inputA.value
              .split(/\s+/g)
              .map(syllable)
              .reduce(sum);
          }
          //---------- End Event Listener block Haiku Input A--------------------//
          
           //---------- Start Event Listener block Haiku Input B--------------------//
           var $inputB = document.getElementsByTagName("input")[2];
           var $outputB = document.getElementsByTagName("outputB")[0];
  
           $inputB.addEventListener("input", oninputchangeB);
          
           oninputchangeB()
       
          function oninputchangeB() {
            $outputB.textContent = $inputB.value
              .split(/\s+/g)
              .map(syllable)
              .reduce(sum);
          }
          //---------- End Event Listener block Haiku Input B--------------------//
          
           //---------- Start Event Listener block Haiku Input C--------------------//
           var $inputC = document.getElementsByTagName("input")[3];
           var $outputC = document.getElementsByTagName("outputC")[0];
  
           $inputC.addEventListener("input", oninputchangeC);
          
           oninputchangeC()
       
          function oninputchangeC() {
            $outputC.textContent = $inputC.value
              .split(/\s+/g)
              .map(syllable)
              .reduce(sum);
          }
          //---------- End Event Listener block Haiku Input C--------------------//
